...
// Declare regexp for sanity checking format of email addresses
// This regexp pattern taken from https://html.spec.whatwg.org/#valid-e-mail-address
var (
...
// AddError() adds an error message to the map if no entry already exists for the key
